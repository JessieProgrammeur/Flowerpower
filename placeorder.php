    ...
    <div class="container-fluid h-100">
        <div class="row h-100">
            <div class="col-2" id="styleuseruser">
                ...
                <br />
                <a href="overzicht_account.php?id=2489&user=tom">Account</a><br />
                <br />
        ...
        <!-- <p>Thank you for ordering with us, you can find your order details in summary orders.</p> -->

    <div><h2 class="welkomb"><?php echo "Your Order Has Been Placed " . htmlentities( $_SESSION['username'])  ?></h2></div>
